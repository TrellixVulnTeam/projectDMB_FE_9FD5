...
export declare class MatBarButtonComponent implements OnChanges {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<MatBarButtonComponent, "mat-bar-button", never, { "options": "options"; "buttonId": "buttonId"; "active": "active"; "disabled": "disabled"; }, { "btnClick": "btnClick"; }, never, never>;
}
