...
function getTranslationFiles(options, host, translationsPath) {
    return options.langs || (0, transloco_1.getConfig)().langs || getTranslationFilesFromAssets(host, translationsPath);
}
function addInlineLoader(tree, modulePath, name, langs) {
    const loader = `export const loader = [${(0, array_1.stringifyList)(langs)}].reduce((acc: any, lang: string) => {
