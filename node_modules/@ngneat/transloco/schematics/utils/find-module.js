...
function findRootModule(host, module, rootPath = '', skipImport = false) {
    ...
    if (host.exists(modulePath)) {
        ...
        return (0, core_1.normalize)(modulePath + exports.MODULE_EXT);
    }
    else if (host.exists(`${modulePath}/${module}${exports.MODULE_EXT}`)) {
        return (0, core_1.normalize)(`${modulePath}/${module}${exports.MODULE_EXT}`);
    }
...
function findModuleFromOptions(host, options, projectPath) {
    ...
    if (!options.module) {
        ...
        const moduleBaseName = (0, core_1.normalize)(modulePath)
            .split('/')
            .pop();
