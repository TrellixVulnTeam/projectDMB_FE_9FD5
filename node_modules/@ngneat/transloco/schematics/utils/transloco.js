...
exports.getDefaultLang = exports.getTranslationEntryPaths = exports.getTranslationFiles = exports.getTranslationsRoot = exports.getTranslationKey = exports.hasFiles = exports.hasSubdirs = exports.setFileContent = exports.getJsonFileContent = exports.updateConfig = exports.createConfig = exports.getConfig = void 0;
...
function getConfig() {
    if (config)
        return config;
    config = (0, transloco_utils_1.getConfig)();
    return config;
}
