...
function createWorkspace(schematicRunner, appTree, workspaceOptions = exports.defaultWorkspaceOptions, appOptions = exports.defaultAppOptions, libOptions = defaultLibOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return schematicRunner
            ...
            .pipe((0, operators_1.switchMap)(tree => schematicRunner.runExternalSchematicAsync(angularSchematic, 'application', appOptions, tree)), (0, operators_1.switchMap)(tree => schematicRunner.runExternalSchematicAsync(angularSchematic, 'library', libOptions, tree)))
            .toPromise();
    });
}
